...
PADDING = 2
def max_fill_tree_fast(tree, elements: List[DetailRect], printing=False, visualize=False):
    ...
    for elem in elements:
        while elem.quantity > 0:
            res = tree.insert(elem.w+PADDING, elem.h+PADDING, elem.dxf)
            if not res:
#                 print('cant insert')
...
def visualize_tree(tree):
    print('kd_tree.py -> drawing dont forget me')
