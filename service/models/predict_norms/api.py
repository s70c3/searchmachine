...
from . import common
from .predict_profilnaya import predict_profilnaya
from .predict_gibka import predict_gibka
from .predict_termicheskaya import predict_termicheskaya
from service.models.predict_operations.predict import pilpaper2operations
...
if config.run.models.norms:
    ...
    model_pt = './models/predict_norms/files/predict_norms.pth'
    with open('./models/predict_norms/files/norms_operations.pkl', 'rb') as f:
    ...
    with open('./models/predict_norms/files/details.pkl', 'rb') as f:
        all_details = pickle.load(f)
    with open('./models/predict_norms/files/predict_ops.pkl', 'rb') as f:
        model_predict_ops = pickle.load(f)
    with open('./models/predict_norms/files/predict_ops_massdes.pkl', 'rb') as f:
        model_predict_ops_massdes = pickle.load(f)
else:
    print("Norms prediction havent loaded due config settings")